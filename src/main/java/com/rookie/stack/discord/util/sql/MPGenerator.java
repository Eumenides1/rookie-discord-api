package com.rookie.stack.discord.util.sql;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        packageConfig.setParent("com.rookie.stack.discord.users");//自定义包的路径
        ...
        TableFill tableFill1 = new TableFill("create_at", FieldFill.INSERT);
        TableFill tableFill2 = new TableFill("update_at", FieldFill.INSERT_UPDATE);
        list.add(tableFill1);
        list.add(tableFill2);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://gz-cynosdbmysql-grp-ohj017lr.sql.tencentcdb.com:23186/rookie_discord_api?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}
